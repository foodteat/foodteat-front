                ...
                <figure
                    ...
                    <blockquote class="mx-auto mb-8 max-w-2xl text-gray-500 dark:text-gray-400">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Speechless with how easy this was to
                            integrate</h3>
                        <p class="my-4">"I recently got my hands on FoodTeat Pro, and holy crap, I'm speechless with how
                        ...
                        <p class="my-4">FoodTeat has code in one place and I'm not joking when I say it took me a matter of
