      ...
      <div class="grid mb-8 lg:mb-12 lg:grid-cols-2">
        ...
        >
          <blockquote class="mx-auto mb-8 max-w-2xl text-gray-500 dark:text-gray-400">
            ...
            <p class="my-4">
              "I recently got my hands on FoodTeat Pro, and holy crap, I'm speechless with how easy
              this was to integrate within my application. Most templates are a pain, code is
              scattered, and near impossible to theme.
            </p>
            <p class="my-4">
              FoodTeat has code in one place and I'm not joking when I say it took me a matter of
