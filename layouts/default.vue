  ...
  <footer class="p-4 bg-white md:p-8 lg:p-10 dark:bg-gray-800">
    <div class="mx-auto max-w-screen-xl text-center">
      ...
      <ul class="flex flex-wrap justify-center items-center mb-6 text-gray-900 dark:text-white">
        <li>
          <RouterLink to="/about" class="mr-4 hover:underline md:mr-6"> About Us</RouterLink>
        </li>
        <li>
          <RouterLink to="/faqs" class="mr-4 hover:underline md:mr-6"> FAQs</RouterLink>
        </li>
        <li>
          <RouterLink to="/contact" class="mr-4 hover:underline md:mr-6"> Contact</RouterLink>
        </li>
      </ul>
      <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400"
        >© 2021-2022 <a href="#" class="hover:underline">FoodTeat™</a>. All Rights Reserved.</span
      >
    </div>
  </footer>
</template>
